...
\begin{table}[h]
\centering
\caption{Bootstrap 95\% confidence intervals for subgroup median RR\%
differences (5,000 resamples)}
\begin{tabular}{lcccc}
\toprule
Contrast & Median diff.\ & 95\% CI & Significant & $n_a$ / $n_b$ \\
\midrule
Zn--Al vs Mg--Al & 8.7 & [$-0.7$, 17.2] & no & 128 / 561 \\
Calcined vs uncalcined & 10.1 & [1.7, 17.9] & yes & 457 / 885 \\
Diclofenac vs tetracycline & 15.5 & [8.3, 27.3] & yes & 304 / 208 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[h]
\centering
\caption{Screening-threshold classification (RR\% $\ge$ 80) from the
regression predictions}
\begin{tabular}{lcccc}
\toprule
Task (model) & Precision & Recall & F1 & True positives / $n$ \\
\midrule
Interpolation (HistGB) & 0.92 & 0.58 & 0.71 & 38 / 252 \\
LOSO (Cubist) & 0.32 & 0.06 & 0.10 & 203 / 1342 \\
LOSO (HistGB) & 0.17 & 0.01 & 0.02 & 203 / 1342 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[h]
\centering
\caption{Leave-one-study-out median MAE (RR\%) by dominant pollutant
($\ge$3 studies) and model}
\begin{tabular}{lccccccc}
\toprule
Pollutant & ANN & Cubist & HistGB & KNN & LR & RF & XGB \\
\midrule
